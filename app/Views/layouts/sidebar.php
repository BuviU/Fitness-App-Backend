<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    <li class="nav-item nav-profile">
      <a href="#" class="nav-link">
        <div class="nav-profile-image">
          <img src="<?php echo base_url(); ?>public/uploads/coach_img/<?php echo $sidebar_employee_prof_pic;?>" alt="profile">
          <span class="login-status online"></span>
          <!--change to offline or busy as needed-->
        </div>
        <div class="nav-profile-text d-flex flex-column">
          <span class="font-weight-bold mb-2"><?php echo $sidebar_employee_name; ?></span>
          <span class="text-secondary text-small"><?php echo $sidebar_employee_name; ?></span>
        </div>
          ...
          if ($category['cat_id'] == $menu_item['cat_id']) { ?>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() . $menu_item['url']; ?>">
                ...
                <i class="mdi <?php echo $menu_item['menu_icon']; ?> menu-icon"></i>
    ...
    <div class="card mt-6 logoutDiv" style="margin-left: 20px; margin-right: 20px;">
      <li class="nav-item ml20">
