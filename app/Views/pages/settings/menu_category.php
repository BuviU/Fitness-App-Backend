                    ...
                    foreach ($categories as $category) {
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          // if ($user_role == 1) {
                          ?>
                          <td  style="width:5%;"> <button type="button" class="btn2 btn-gradient-primary btn-rounded btn-fw btn_del" data-category-id="<?php echo $category['id']; ?>"  style="padding: 10px 30px !important; border-radius: 25px !important;">Delete</button></td>
                          <?php 
                        // }
                          ?>
