                        ...
                        <tr data-id="<?php echo $coach['id'];?>">
                          ...
                          <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                              ...
                              <button type="button" class="btn btn-outline-primary edit_btn" data-toggle="modal" data-target="#edit_data">
                            ...
                            <div style="display: flex; justify-content: center;">
                                 <button type="button" class="btn1 btn-rounded btn-danger delete_btn"><i class="mdi mdi-delete"></i></button>
                            </div>
